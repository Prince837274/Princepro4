...
public class MarksheetModel {
	...
	public void add(MarksheetBean bean) throws Exception {
		...
		System.out.println("data instered => " + i);
	...
	public void update (MarksheetBean bean) throws Exception {
		...
		PreparedStatement pstmt = conn.prepareStatement("update st_marksheet set rollNo = ?, studentId = ?, name = ?, physics = ?, chemistry = ?, maths =?, created_by =?, modified_by = ?, created_datetime =?, modified_datetime =? where id =?");
	   ...
	   public MarksheetBean findByPk(long i) throws Exception {
